...
const cards = [
    {
        question: "Message de haine – Quelqu’un t’a envoyé un message de haine. Que fais-tu ? Tu signales le message ou tu réponds",
        consequence: "Signale ce message."
    },
    {
        question: "Publication inappropriée – Tu as partagé une photo d’un ami sans son consentement. Que fais-tu ? Tu la retires ou tu ne t'excuses pas.",
        consequence: "Retire-la."
    },
    {
        question: "Témoignage – Tu vois un message offensant à propos d’un camarade de classe. Que fais-tu ? Tu le signales ou tu ne fais rien ?",
        consequence: "Tu le signales."
    },
    {
        question: "Demande d’aide – Un ami te demande de l’aide car il est harcelé. Que fais-tu ? Tu le signales ou tu le harcèles aussi ?",
        consequence: "Tu l’aides en signalant."
    }
];
